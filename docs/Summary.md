...
| [PX1110](diagnostics/PX1110.md) | The DAC has DAC field with the `PXDBLocalizableString` attribute. Therefore, this DAC must declare `NoteID` DAC field. | Error | Available |
