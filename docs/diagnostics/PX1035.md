...
For the same set of DAC fields the PX1035 diagnostic considers dirty primary and unique keys to be different from regular keys. You can have both regular and dirty primary keys with the same set of fields in a DAC.
