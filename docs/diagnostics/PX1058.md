...
A `PXGraph` instance cannot save changes to the database during the `PXGraph` initialization. The following code elements are considered parts of the graph initialization:
