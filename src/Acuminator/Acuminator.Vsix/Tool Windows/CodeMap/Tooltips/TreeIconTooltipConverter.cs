	...
	public class TreeIconTooltipConverter : IValueConverter
	{
		public object? Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			...
			return icon switch
			{
				...
				Icon.DacSystemField								=> VSIXResource.CodeMap_ExtraInfo_DacSystemNonAuditFieldIconTooltip,
				Icon.DacSystemFieldsCategory					=> VSIXResource.CodeMap_ExtraInfo_DacSystemNonAuditFieldsCategoryIconTooltip,
