...
namespace Acuminator.Runner.Input
{
	internal class CommandLineOptions
	{
		...
		[Option(longName: CommandLineArgNames.DisableSuppressionMechanism,
				HelpText = "When this optional flag is specified, the code analysis report suppressed Acuminator errors.")]
		...
		/// <summary>
		/// This flag regulates how the locations of API usages will be output.<br/>
		///	By default, file paths in locations are relative to the containing project directory. However, if this flag is set then the absolute file paths will be used.
		/// </summary>
		[Option(longName: CommandLineArgNames.OutputAbsolutePathsToUsages,
				HelpText = "This flag regulates how the locations of API usages will be output.\n" +
