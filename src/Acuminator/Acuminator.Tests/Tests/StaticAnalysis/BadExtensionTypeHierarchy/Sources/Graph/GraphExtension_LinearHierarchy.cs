...
namespace Acuminator.Tests.Tests.StaticAnalysis.BadExtensionTypeHierarchy.Graph.Sources
{
	...
	public class ThirdLevelGraphExtension : PXGraphExtension<DerivedSecondLevelGraphExtension, BaseExtension, MyGraph>
	{
	}
	...
	// Acuminator disable once PX1016 ExtensionDoesNotDeclareIsActiveMethod extension should be constantly active
	public abstract class SecondLevelGraphExtension : PXGraphExtension<BaseExtension, MyGraph>
	{
	}
